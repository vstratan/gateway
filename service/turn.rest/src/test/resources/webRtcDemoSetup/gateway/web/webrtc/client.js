...
var conn;
var session;
var jmsServerURL = 'wss://gateway.kaazing.webrtc.demo:18000/jms';
...
/*
  ...
  "urls": [
	"turn:coturn.webrtc.demo:3478?transport=tcp"
    //"turn:10.2.56.35:3478"
  ]
}]
         };
...
/*        var configuration = { 
            "iceServers": [{
  "username": "1472656919:joe",
  "credential": "yNN4HQnlWqGuNWcjh/FdACF8GqE=",
  "ttl": 22400,
  "urls": [
    "turn:10.2.56.35:3478"
  ]
...
function startChat() { 
      ...
      if (navigator.mediaDevices.getUserMedia) {
        navigator.mediaDevices.getUserMedia({ video: true, audio: true }, handleVideo, function (error) { 
            console.log("1", error); 
        }); 
      } else {
          navigator.kaazGetUserMedia({ video: true, audio: true }, handleVideo, function (error) { 
              console.log("1", error); 
        }); 
      }
